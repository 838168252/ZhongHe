...
public class dataAdapter extends BaseAdapter {
    ...
    private dataBtn1ClickListener dataBtn1ClickListener;
    ...
    public void setDataBtn1ClickListener(dataBtn1ClickListener dataBtn1ClickListener) {
        this.dataBtn1ClickListener = dataBtn1ClickListener;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = View.inflate(context, R.layout.item_datalist, null);
            ...
            viewHolder.a_but1 = convertView.findViewById(R.id.a_but1);
        ...
        if (viewHolder != null) {
            ...
            //按钮1
            viewHolder.a_but1.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    dataBtn1ClickListener.dataBtn1ClickListener(view,position);
                }
            });
            //按钮2
